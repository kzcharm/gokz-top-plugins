...
public void OnPluginStart()
{
	...
	gCV_APIKey = CreateConVar("gokz_top_api_key", "",
		...
		FCVAR_PROTECTED);
	ServerCommand("exec %s/apikey.cfg", GOKZ_TOP_CFG_FOLDER);
...
void CreateAPIKeyConfigIfNotExists()
{
	...
	file.WriteLine("// Set this to the API key from your gokz.top server group.");
	file.WriteLine("");
	file.WriteLine("gokz_top_api_key \"\"");
	file.WriteLine("");
	delete file;
}
